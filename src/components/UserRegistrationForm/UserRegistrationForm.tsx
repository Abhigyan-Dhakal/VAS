...
import { setRegistrationData } from "../../redux/slices/registrationFormSlice";

const { Option } = Select;

type Props = {};

export const UserRegistrationForm = (props: Props) => {
  const data = useSelector((state: RootState) => {
    return state.registrationFormReducer.data;
  });
